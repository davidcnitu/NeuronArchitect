...
Unity desktop application for reconstructing and visualizing 3D neural morphology, using the Marching cubes computer graphics algorithm. ![](https://github.com/davidcnitu/NeuronArchitect/RecontructionProcess.gif)
